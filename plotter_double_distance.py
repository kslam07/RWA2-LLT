...
ax_circ[1].grid(True)
fig_circ.suptitle(r"Radial distribution of $\Gamma$ for various $\gamma$", fontsize=14)
...
ax_ind[0].grid()
ax_ind[1].grid()
fig_ind.suptitle(r"Radial distribution of $a$ for various $\gamma$", fontsize=14)
...
ax_aoa[1].grid(True)
fig_aoa.suptitle(r"Radial distribution of $\alpha$ for various $\gamma$", fontsize=14)