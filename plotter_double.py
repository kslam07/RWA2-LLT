...
ax[0].plot(data_double[2][:nspan - 1], data_double[0][:nspan - 1], label="LLM - double rotor 1")
ax[0].plot(data_double[2][-(nspan - 1):], data_double[0][-(nspan - 1):], label="LLM - double rotor 2")
ax[0].plot(data_single[2][-(nspan - 1):], data_single[0][-(nspan - 1):], label="LLM - single rotor")
ax[1].plot(data_double[2][:nspan - 1], data_double[1][:nspan - 1])
ax[1].plot(data_double[2][-(nspan - 1):], data_double[1][-(nspan - 1):])
ax[1].plot(data_single[2][:nspan - 1], data_single[1][:nspan - 1])
